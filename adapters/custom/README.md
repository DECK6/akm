...
| ② | Session start | All of `40-memory/` + `99-system/INDEX.md` |
| ③ | Routing | `99-system/ROUTER.md` classification tree before every save |
| ④ | Learn Back | `99-system/LOOP.md` mapping table on failures |
