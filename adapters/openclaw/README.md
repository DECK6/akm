...
| ② | Session start | All of `40-memory/` + `99-system/INDEX.md` (instructed by the `AGENTS.md` snippet) |
| ③ | Routing | Every save passes the classification tree in `99-system/ROUTER.md` |
| ④ | Learn Back | On failure or repeated mistakes, apply the mapping table in `99-system/LOOP.md`. Daily-log promotions also pass through ROUTER |
